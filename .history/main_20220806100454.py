    ...
    def setup(self):
        ...
        for i in range(10):            
            ...
            for o in range(10):
                countes = 1
                for i in range(5):
                    wall = arcade.Sprite(":resources:images/tiles/grassCenter.png", SPRITE_SCALING+0.3)
                    wall.center_x =  10000
                ...
                y_heights = rand
            for j in range(rand):
                wall = arcade.Sprite(":resources:images/tiles/sandMid.png", SPRITE_SCALING+0.3, image_width=SPRITE_PIXEL_SIZE, image_height=SPRITE_PIXEL_SIZE)
                # wall.bottom = 20 * 
                wall.center_x = (j)*random.randint(6,10)* GRID_PIXEL_SIZE 
