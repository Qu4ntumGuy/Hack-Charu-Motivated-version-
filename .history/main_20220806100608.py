    ...
    def setup(self):
        ...
        for i in range(10):            
            ...
            for o in range(10):
                ...
                y_heights = rand
            for j in range(rand):
                wall = arcade.Sprite(":resources:images/tiles/sandMid.png", SPRITE_SCALING+0.2, image_width=SPRITE_PIXEL_SIZE, image_height=SPRITE_PIXEL_SIZE, repeat_count_x=2)
                # wall.bottom = 20 * 
